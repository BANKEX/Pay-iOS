...
//        let fetchRequest: NSFetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "")
...
//        self.fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: context, sectionNameKeyPath: nil, cacheName: nil)
        self.fetchRequest = NSFetchRequest(entityName: "")
...
//        switch type {
//        case .delete:
//            self.batchChanges.append(.delete(indexPath![0], object))
//        case .insert:
//            self.batchChanges.append(.insert(newIndexPath![0], object))
//        case .update:
//            self.batchChanges.append(.update(indexPath![0], object))
//        default: break
//        }
    }
