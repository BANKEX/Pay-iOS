...
class CollectionViewCell: UICollectionViewCell {
    ...
    func configureCell(withText text: String, isCellRed: Bool = false) {
        wordLabel.text = text
        wordLabel.textColor = isCellRed ? UIColor(red: 255/255, green: 59/255, blue: 48/255, alpha: 1) : WalletColors.createWalletCellColor
        ...
        layer.borderColor = isCellRed ? #colorLiteral(red: 1, green: 0.231372549, blue: 0.1882352941, alpha: 1) : WalletColors.createWalletCellColor.cgColor
    ...
    private func initialConfiguration() {
        ...
        layer.borderColor = WalletColors.createWalletCellColor.cgColor
